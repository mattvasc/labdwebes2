CREATE OR REPLACE FUNCTION select_movie_actors_in_common(genre TEXT, actor_one TEXT, actor_two TEXT, actor_tree TEXT, actor_four TEXT, actor_five TEXT)
RETURNS TABLE (films TEXT) AS
